...
AppMutex=ScaleReportSetupMutex
...
[UninstallRun]
; Nothing special — DB lives in %APPDATA%\Scale Report (preserved on uninstall)
...
begin
  ...
  Exec('taskkill.exe', '/F /IM ScaleReportGUI.exe', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
  Result := True;
end;
...
begin
  ...
  begin
    MsgBox(
      ...
      '%APPDATA%\Scale Report' + #13#10 + #13#10 +
