...
#define AppName      "Dejavu CLI"
#define Dir          "Dejavu CLI"

#define AppVersion   "1.0.0"
#define AppPublisher "Ahsanur Rahman"
#define AppExeName   "Dejavu.exe"
#define AppId        "{{A3F2C1D4-89B0-4E7A-9C3F-1D2E5B6A7F8E}"
#define SourceDir    "dist\Dejavu.exe"
...
; Output
OutputDir=installer
OutputBaseFilename={#Dir}_Setup_v{#AppVersion}
...
begin
  ...
  Exec('taskkill.exe', '/F /IM Dejavu.exe', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
  Result := True;
end;
...
begin
  ...
  begin
    MsgBox(
      'Dejavu has been uninstalled.' + #13#10 + #13#10 +
